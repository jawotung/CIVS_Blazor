...
{
    public interface IInwardClearingChequeServices
    {
        Task<ReturnGenericDropdown> GetStatusList(); 
        Task<ReturnGenericData<PaginatedOutputServices<InwardClearingChequeDetailsModel>>> GetICCList(string key, int? page, ParamInwardClearingChequeGetList value);
