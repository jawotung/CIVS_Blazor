...
{
    public interface IInwardClearingChequeReportServices
    {
        Task<PaginatedOutputServices<InwardClearingReportModel>> GetReportList(string Key, int page = 1, string? dateFromFilter = null, string? dateToFilter = null, string? BSRTNFilter = null);
